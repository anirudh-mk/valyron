...
export default function VariantsSection() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between p-3.5 border border-blue-100 dark:border-blue-900/50 bg-blue-50/50 dark:bg-blue-950/20 rounded-lg text-sm text-blue-800 dark:text-blue-200">
        <div className="flex items-center gap-2.5">
          <Info className="size-4 text-blue-600 dark:text-blue-400 shrink-0" />
          <span>Variants allow you to manage different options (e.g. Color, Storage) for this product.</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-xs font-medium text-muted-foreground select-none">Enable Variants</span>
          <Switch
        ...
        <>
          ...
          <Card className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-semibold">Variant Attributes</h2>
            ...
            <Button
              variant="outline"
              className="w-fit h-9 px-3 gap-1.5 border-dashed text-xs text-muted-foreground hover:text-foreground"
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Variants are generated from the combination of attributes.</p>
              </div>
              <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div>
                          ...
                          <p className="text-[10px] text-muted-foreground mt-0.5 leading-none">in {variant.warehouseCount} WH</p>
                        </div>
                      </td>
